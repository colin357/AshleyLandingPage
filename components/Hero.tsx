        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          <div>
            <span className="inline-block rounded-full bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-brand-100 ring-1 ring-white/20">
              Licensed in all 50 states · NMLS #250615
            </span>
            ...
            <p className="mt-5 max-w-xl text-lg text-brand-100">
              I&apos;m Ashley Hickmon, SVP of Sales Development &amp; Growth at
              Fairway Home Mortgage. From first-time buyers to seasoned
              investors, I guide you from application to closing — and beyond.
            </p>
          ...
          <div className="relative mx-auto w-full max-w-md">
            ...
            <div className="relative overflow-hidden rounded-[2rem] bg-white/10 p-2 ring-1 ring-white/20 backdrop-blur">
              <Image
                src="/ashley.jpg"
                alt="Ashley Hickmon, Loan Officer with Fairway Home Mortgage"
                width={720}
                height={900}
