    ...
    return (
      <div className="rounded-2xl bg-white p-8 text-center shadow-lg ring-1 ring-slate-200">
        ...
        <p className="mt-2 text-slate-600">
          Your information is on its way to Ashley. She&apos;ll reach out
    ...
    <div className="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-slate-200 sm:p-8">
      ...
      <div className="min-h-[260px]">
        ...
        {step === 5 && (
          <div className="space-y-6">
            ...
            <StepRadio
              ...
              sublabel="Ashley is a certified Military Mortgage specialist — VA loans often beat conventional."
        ...
        {step === 6 && (
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Ashley is licensed in all 50 states.
            </p>
            <select
              value={form.state}
              onChange={(e) => update("state", e.target.value)}
              className="mt-4 w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-slate-900 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-100"
            >
        ...
        {step === 8 && (
          <div>
            <h3 className="text-xl font-semibold text-slate-900">
              Last step — how should Ashley reach you?
            </h3>
            ...
            <label className="mt-5 flex cursor-pointer items-start gap-3 text-sm text-slate-600">
              ...
              />
              <span>
                I agree to be contacted by Ashley Hickmon and Fairway Home
      ...
      <div className="mt-6 flex items-center justify-between">
        ...
        {step < steps.length - 1 ? (
          ...
          >
            {submitting ? "Sending…" : "Send to Ashley"}
          </button>
        )}
      </div>
    </div>
